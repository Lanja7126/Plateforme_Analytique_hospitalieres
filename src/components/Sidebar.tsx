...
const ELEMENTS_MENU: ElementMenu[] = [
  {
    to: "/dashboard",
    label: "Accueil",
    icon: <Home className="my-1.5 inline-block size-4" />,
  },
  {
    to: "/dashboard/regional",
    label: "Dashboard régional",
    icon: <Map className="my-1.5 inline-block size-4" />,
  },
  {
    to: "/dashboard/etablissement",
    label: "Fiche établissement",
    icon: <Building2 className="my-1.5 inline-block size-4" />,
  },
  {
    to: "/dashboard/prediction",
    label: "Prédiction de risque",
    icon: <AlertTriangle className="my-1.5 inline-block size-4" />,
  },
  {
    to: "/dashboard/import",
  ...
  },
  {
    ...
    label: "Méthodologie",
    icon: <BookOpen className="my-1.5 inline-block size-4" />,
  },
];
      ...
      <div className="drawer-side is-drawer-close:overflow-visible">
        ...
        <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
          ...
          <div className="w-full border-t border-base-300 p-2">
            <div
              className="is-drawer-close:tooltip is-drawer-close:tooltip-right flex items-center gap-2 px-2 py-1"
              data-tip={utilisateur?.email}
            >
              ...
              <div className="is-drawer-close:hidden overflow-hidden">
                ...
                <p className="badge badge-ghost badge-xs">
                  {utilisateur?.role}
                </p>
              </div>
            </div>
